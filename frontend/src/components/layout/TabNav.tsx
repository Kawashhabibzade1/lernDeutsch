...
const tabs = [
  ...
  { href: "/scenarios",  label: "Scenarios",  icon: MessageSquare },
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl p-6 w-80 shadow-2xl border border-slate-200 dark:border-slate-700">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-base font-semibold text-slate-800 dark:text-slate-100">
                Turn off DeutschPath?
              </h2>
            </div>
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-5 leading-relaxed">
              This stops the backend and frontend servers completely.
              Double-click <strong>DeutschPath.app</strong> to start again.
            </p>
          ...
          <div className="text-center px-6">
            {shutdownState === "shutting-down" ? (
              <>
                ...
                <h1 className="text-2xl font-bold text-white mb-2">Shutting down…</h1>
                <p className="text-slate-400 text-sm">Stopping all servers</p>
              </>
            ) : (
              <>
                ...
                <h1 className="text-2xl font-bold text-white mb-2">DeutschPath stopped</h1>
                <p className="text-slate-400 text-sm">
                  Double-click <strong className="text-slate-300">DeutschPath.app</strong> to start again.
                </p>
              </>
            )}
          </div>
